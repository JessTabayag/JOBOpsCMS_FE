...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="welcome.blade.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="welcome.blade.php" class="nav-link">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/forms/general.blade.php" class="nav-link active">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-header">
            <div>
              <button onclick="window.location.href='general.blade.php'"> Return to the ticket list </button>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                    ...
                    <div class="form-group">
                      <label for="exampleInputUnit">Unit</label>
                        <select name="unit" id="unit">
                          <option value="cea">Repair Unit</option>
                          <option value="ccs">Network Unit</option>
                          <option value="cas">MIS Unit</option>
                        </select>
                    </div>
